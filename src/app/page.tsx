  ...
  return (
    <div className="bg-slate-50">
      <section>
        ...
        lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52"
        >
          <div className="col-span-2 px lg:px-0 lg:pt-4">
            <div
            ...
            >
              ...
              >
                ...
                <span className="font font-semibold"> one-of-one </span>
